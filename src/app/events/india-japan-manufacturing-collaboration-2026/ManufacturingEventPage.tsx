...
const getPartnerLogo = (name: string): string | null => {
  ...
  if (n.includes('machine tool') || n.includes('工作機械') || n.includes('jmtba')) return '/events/JMTBA.jpg'
  if (n.includes('semiconductor equipment') || n.includes('半導体製造装置') || n.includes('seaj')) return '/events/SEAJ.gif'
  if (n.includes('machinery federation') || n.includes('機械工業連合') || n.includes('jmf')) return '/events/JMF.png'
