...
export default function EventsLandingPage() {
  ...
  // All event gallery images
  const allGalleryImages = [
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 5.51.35 PM.jpeg', alt: locale === 'ja' ? 'イベント会場の様子' : 'Event venue atmosphere' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 5.51.35 PM (1).jpeg', alt: locale === 'ja' ? 'セミナー会場' : 'Seminar hall' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 5.51.35 PM (2).jpeg', alt: locale === 'ja' ? '参加者の様子' : 'Event participants' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 5.51.35 PM (3).jpeg', alt: locale === 'ja' ? 'プレゼンテーション' : 'Presentation' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.40 PM.jpeg', alt: locale === 'ja' ? 'ネットワーキングセッション' : 'Networking session' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.41 PM (1).jpeg', alt: locale === 'ja' ? '講演の様子' : 'Speaking session' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.41 PM.jpeg', alt: locale === 'ja' ? 'セミナー講演の様子' : 'Seminar presentation' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.42 PM (1).jpeg', alt: locale === 'ja' ? '参加者との交流' : 'Participant interaction' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.42 PM.jpeg', alt: locale === 'ja' ? '参加者のネットワーキング' : 'Attendee networking' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.43 PM.jpeg', alt: locale === 'ja' ? 'パネルディスカッション' : 'Panel discussion' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.44 PM.jpeg', alt: locale === 'ja' ? '展示ブース' : 'Exhibition booth' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.44 PM (1).jpeg', alt: locale === 'ja' ? 'イベント展示' : 'Event exhibition' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.44 PM (2).jpeg', alt: locale === 'ja' ? '参加企業ブース' : 'Company booth' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.45 PM (1).jpeg', alt: locale === 'ja' ? '懇親会の様子' : 'Reception gathering' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.45 PM (2).jpeg', alt: locale === 'ja' ? 'ネットワーキングパーティー' : 'Networking party' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.45 PM (3).jpeg', alt: locale === 'ja' ? '参加者の交流会' : 'Participant meetup' },
    { src: '/events/event-gallery/WhatsApp Image 2026-03-20 at 6.32.45 PM.jpeg', alt: locale === 'ja' ? 'イベント懇親会' : 'Event reception' },
  ]
  ...
  useEffect(() => {
    ...
    if (!showAllImages) {
      // Randomly swap images every 5 seconds (slower)
          ...
          <div className="evl-collage-grid-wrapper">
            <div className={`evl-collage-grid-container ${showAllImages ? 'expanded' : ''}`}>
              <AnimatePresence mode="sync">
                <motion.div
                  key={displayedImages.map(img => img.src).join('-')}
