  ...
  const events = {
    ...
    mobility: {
      ...
      en: {
        ...
        program: [
          { time: '14:00-14:10', speaker: '', org: '', topic: 'Opening & Welcome', isBreak: false },
          { time: '14:10-14:50', speaker: 'ACMA Representative', org: 'ACMA', topic: 'Bharat Mobility 2027 & India Automotive Industry Outlook', isBreak: false },
          { time: '14:50-15:20', speaker: 'JETRO Representative', org: 'JETRO', topic: 'Support for Japanese Companies Entering India', isBreak: false },
          { time: '15:20-15:50', speaker: 'JAPIA Representative', org: 'JAPIA', topic: 'JAPIA\'s India Market Initiatives & 2025 Delegation Report', isBreak: false },
          { time: '15:50-16:10', speaker: '', org: '', topic: 'Break', isBreak: true },
          { time: '16:10-16:40', speaker: 'FOURIN Analyst', org: 'FOURIN', topic: 'India Automotive Market Analysis', isBreak: false },
          { time: '16:40-17:10', speaker: 'S&P Global Mobility Analyst', org: 'S&P Global', topic: 'India Market Mid-to-Long Term Forecast', isBreak: false },
          { time: '17:10-17:40', speaker: 'Seiichi Kondo', org: 'Resonac', topic: 'Why is Semiconductor Industry Profitability High?', isBreak: false },
          { time: '17:40-17:50', speaker: '', org: '', topic: 'Q&A & Networking', isBreak: false, isHighlight: true }
        ],
      ...
      ja: {
        ...
        deadline: '4月30日（木）',
        program: [
          { time: '14:00-14:10', speaker: '', org: '', topic: '開会・ご挨拶', isBreak: false },
          { time: '14:10-14:50', speaker: 'ACMA担当者', org: 'ACMA', topic: 'Bharat Mobility 2027 & インド自動車産業展望', isBreak: false },
          { time: '14:50-15:20', speaker: 'JETRO担当者', org: 'JETRO', topic: 'インドにおける日本企業の進出支援など', isBreak: false },
          { time: '15:20-15:50', speaker: 'JAPIA担当者', org: 'JAPIA', topic: 'インド市場向けてのJAPIAの取り組み & 2025年インド視察団報告', isBreak: false },
          { time: '15:50-16:10', speaker: '', org: '', topic: '休憩', isBreak: true },
          { time: '16:10-16:40', speaker: '株式会社フォーイン', org: 'FOURIN', topic: 'インド現状の自動車市場分析', isBreak: false },
          { time: '16:40-17:10', speaker: 'S&P Global Mobility', org: 'S&P Global', topic: 'インド市場の中長期 未来市場予測', isBreak: false },
          { time: '17:10-17:40', speaker: '近藤誠一 氏', org: 'レゾナック', topic: '半導体産業の利益率はどうして高いのか？', isBreak: false },
          { time: '17:40-17:50', speaker: '', org: '', topic: '質疑応答 & ネットワーキング', isBreak: false, isHighlight: true }
        ],
